...
import { FaUserShield, FaEnvelope, FaUserCircle, FaStar, FaTimes } from 'react-icons/fa';
    ...
    return (
        <div className=" bg-gray-100 flex items-center justify-center py-12 px-4">
            <div className="bg-white shadow-xl rounded-lg p-8 max-w-lg w-full">
                ...
                {/* User Details */}
                <h2 className="text-2xl font-semibold text-center text-gray-800">{currentUser?.name || "User Name"}</h2>
                <p className="text-center text-gray-500 mt-1">{currentUser?.email || "user@example.com"}</p>
                    ...
                    <div className="fixed inset-0 flex items-center justify-center bg-opacity-50 p-6 bg-gray-800">  
                        <div className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full">
                            <div className="flex justify-between items-center border-b pb-2">
                                <h3 className="text-xl font-bold text-gray-800">How to Increase Trust Score?</h3>
                            ...
                            <div className="mt-4">
                                <p className="text-gray-700">
                                    Your trust score reflects how helpful and responsible you are in returning lost items.
                                </p>
                                <ul className="mt-3 list-disc list-inside text-gray-600 space-y-2">
                                    ...
                                    <li>🌟 Help verify lost and found reports.</li>
                                </ul>
                            </div>
